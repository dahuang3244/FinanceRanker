...
COLUMNS: list[Column] = [
    ...
    ("Market", "1Y return", "return_1y"),
    ("Market", "Beta", "beta"),
    ("Market", "52W drawdown", "drawdown_52w"),
    ("Market", "Analyst target", "analyst_target"),
    ("Market", "Analyst upside", "analyst_upside"),
    # --- growth ---
    ...
    ("Growth", "EPS growth FY1", "eps_growth_fy1"),
